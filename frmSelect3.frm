...
Begin VB.Form frmSelect3 
   Caption         =   "Select"
   ClientHeight    =   9495
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13185
   Icon            =   "frmSelect3.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   9495
   ScaleWidth      =   13185
...
frmSelect3.Caption = CurrentStatement
Select03InUse = True
   ...
   For z = 0 To srs.Fields.Count - 1
      ...
      Select Case srs.Fields(z).Type
         ...
         Case 129, 200, 135, 202, 203, 11, 72, 201, 205, 130
            'If srs.Fields(z).Type = 72 Then Stop
            If IsNull(srs.Fields(z).Value) Then
               flex.Text = ""
               If NullReq = "Y" Then
                  flex.Text = "Null"
